...
def calc_precision(time_slices, gt):
    ...
    ts_result['actual_time']= [datetime.datetime.fromtimestamp(i) for i in ts_result['Event Time']]
...
def calc_recall(time_slices, gt):
    ...
    #gt = gt.sort(['act_time'])
    gt['actual_time']= [datetime.datetime.fromtimestamp(i) for i in gt['Event Time']]
    print "Recall table\n", gt
